...
<head>
  ...
  <title>Jelataku | Input Data Wisata</title>
...
<div class="container my-5">
  ...
  <div class="card">
    <div class="card-header">
      <h2><i class="fa-solid fa-location-dot"></i> Input Data Wisata</h2>
    </div>
    <div class="card-body">
      <form action="<?= base_url('home/simpan_tambah_data/') ?>" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="wisata" name="wisata" placeholder="Isikan nama objek">
        </div>
        <div class="mb-3">
          <label for="jenis" class="form-label">Jenis</label>
          <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Isikan nama objek">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Isikan nama objek">
        </div>
        <div class="mb-3">
          <label for="" class="form-label">HTM</label>
          <input type="text" class="form-control" id="htm" name="htm" placeholder="Isikan nama objek">
        </div>
        <div class="mb-3">
...
<script>
  ...
  let center = [-7.779506691455926, 110.16833243117082];
